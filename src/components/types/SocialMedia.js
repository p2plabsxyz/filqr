          ...
          <Link to="/">
            ...
            <form onSubmit={handleData}>
              <input
                ...
                placeholder="Heading"
                className="mt-2 w-60 bg-white rounded border border-gray-300 focus:ring-2 focus:ring-indigo-200 focus:bg-white focus:border-indigo-500 text-base outline-none text-gray-700 px-3 leading-8 transition-colors duration-200 ease-in-out"
                required
              />
              <textarea
                type="text"
                ...
                placeholder="About (max length 240 characters)"
