...
function Apps({
  ...
  const [appIconLink, setAppIconLink] = useState(null);
  ...
  async function handleIconFileChange() {
    ...
    const iconCid = await client.put(iconInput.files, {
      wrapWithDirectory: false,
    });
    setAppIconLink(`https://dweb.link/ipfs/${iconCid}/`);
  ...
  async function handleData(e) {
    ...
    const blob = new Blob(
      [
        `<!DOCTYPE html> <html lang="en"> <head> <meta charset="UTF-8" /> <meta http-equiv="X-UA-Compatible" content="IE=edge" /> <meta name="viewport" content="width=device-width, initial-scale=1.0" /> <title>Apps</title> <style> html, body { background-color: white; margin: auto; overflow-x: hidden; color: black; font-family: ui-sans-serif, system-ui, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", Arial, "Noto Sans", sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Noto Color Emoji"; } .header { padding-top: 8rem; padding-bottom: 8rem; margin-bottom: -7rem; color: #ffffff; text-align: center; background-color: ${color}; } h2 { margin-bottom: 1rem; font-size: 1.5rem; line-height: 2rem; font-weight: 500px; text-align: center; align-items: center; color: #1f2937; } .desc { text-align: center; align-items: center; color: #374151; margin-bottom: 4rem; } .img { object-fit: cover; object-position: center; border-radius: 2rem; box-shadow: 0 20px 25px -5px rgb(0 0 0 / 0.1), 0 8px 10px -6px rgb(0 0 0 / 0.1); } .apps-link { text-align: center; align-items: center; color: #374151; text-decoration: none; } .apps-link:hover { text-decoration: underline; } .link{ display: block; margin: 20px; } .main { padding-left: 2rem; padding-right: 2rem; text-align: center; align-items: center; margin-left: -0.5rem; margin-right: -0.5rem; box-sizing: border-box; margin-bottom: 3rem; } .apps-div { padding: 0.5rem; width: 100%; } /* Small (sm) */ @media (min-width: 640px) { h2 { font-size: 1.875rem; line-height: 2.25rem; } .main { margin-bottom: 3rem; margin-left: auto; margin-right: auto; } .apps-div { width: 50%; } .link{ display: inline-flex; } } /* Medium (md) */ @media (min-width: 768px) { } /* Large (lg) */ @media (min-width: 1024px) { .main { margin-bottom: 3rem; width: 66%; } .img { height: auto; width: 35%; } } /* Extra Large (xl) */ @media (min-width: 1280px) { } </style> </head> <body> <section> <div> <div class="header"></div> <div class="main"> <center> <div class="apps-div"> <img class="img" alt="App icon image" width="150" src="${
          appIconLink == null
            ? "https://dweb.link/ipfs/bafkreibyt2bpmugfhth7kqanmtz7377qhs6ja7g6oct52l2pilfd4cwwkm/"
            : appIconLink
        }" /> <h2>${name}</h2> <p class="desc">${desc}</p> <div class="apps-link"> <a class="link" href="${appStore}" target="_blank" rel="noopener noreferrer" ><img width="180" src="https://dweb.link/ipfs/bafkreigt4v6z6bkei5pzb72jcoymnrgbcqvemrnpwfhfxuv6cg7bunb4aq/" /></a> <a class="link" href="${playStore}" target="_blank" rel="noopener noreferrer" ><img width="185" src="https://dweb.link/ipfs/bafkreibpn6dyza4xwl4muu4zdlquhhd4n2vbvzbe7ktjd3cicpbdw4ouje/" /></a> </div> </div> </center> </div> </div> </section> </body> </html> `,
      ],
      { type: "text/html" }
    );
    ...
    if (getQrCodeContract) {
      try {
        ...
        await getQrCodeContract.methods
          .uploadFile(cid, file[0].size, "Apps")
        ...
        <div className="container mx-auto flex px-44 py-32 md:flex-row flex-col items-center">
          <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
            ...
            <p class="block mt-2 text-sm font-medium text-gray-600">
              Promote your app store and play store apps.
            </p>
